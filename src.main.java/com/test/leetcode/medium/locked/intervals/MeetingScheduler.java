 ...
 * 
 * Given the availability schedules slots1 and slots2 of two people, and the expected duration of the meeting, 
 * you are asked to schedule the earliest and appropriate meeting time in the interval for them.

The format of an availability schedules is an Interval consisting of a start time and an end time, 
i.e., (start, end), which means that it starts at start and ends at end.
